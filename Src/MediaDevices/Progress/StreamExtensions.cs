...
public static class StreamExtensions {
	/// <summary>
	/// Asynchronously copies the contents from a source stream to a destination stream with progress reporting.
	/// </summary>
	/// <param name="sourceStream">The source stream to copy from (this).</param>
