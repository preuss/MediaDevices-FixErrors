...
namespace MediaDeviceApp.ViewModel
{
    public class StillImageViewModel : BaseViewModel
    {
        ...
        {
            this.stillImageSource = new BitmapImage(new Uri("pack://application:,,,/Images/Folder.png"));
        ...
        {
            this.device = device;
            this.IsStillImageSupported = this.device.FunctionalCategories().Any(c => c == FunctionalCategory.StillImageCapture);
